...
class CatalogWorker(QThread):
    ...
    def _keyword_only_url(self):
        ...
        return f"https://catalog.roproxy.com/v1/search/items/details?{params}"
        ...
        try:
            ...
            if category is not None:
                try:
                    ...
                    url = f"https://catalog.roproxy.com/v1/search/items/details?{urllib.parse.urlencode(precise_params)}"
                    data = fetch_json(url)
